...
Webflow.require('ix').init([
  {"slug":"rotate","name":"Rotate","value":{"style":{"rotate":"-90deg"},"triggers":[]}},
  {"slug":"move-arrow","name":"Move Arrow","value":{"style":{},"triggers":[{"type":"dropdown","selector":".arrow-drop","stepsA":[{"transition":"transform 200ms ease 0ms","rotate":"0deg"}],"stepsB":[{"transition":"transform 200ms ease 0ms","rotate":"-90deg"}]}]}},
  {"slug":"outer-pulser","name":"Outer Pulser","value":{"style":{"opacity":0},"triggers":[{"type":"scroll","loopA":true,"stepsA":[{"opacity":0,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","scale":0.4},{"opacity":1,"transition":"transform 1000ms ease-out-quart 0ms, opacity 1000ms ease 0ms","scale":1},{"opacity":0,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","scale":0.92}],"stepsB":[]}]}},
  {"slug":"0-on-load","name":"0% on load","value":{"style":{"opacity":0,"x":"-10px","y":"0px"},"triggers":[]}},
  {"slug":"hover-tooltip","name":"Hover Tooltip","value":{"style":{},"triggers":[{"type":"hover","selector":".tooltip","descend":true,"stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[{"opacity":0,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"-10px","y":"0px"}]}]}},
  ...
  {"slug":"from-top-on-load","name":"From Top on Load","value":{"style":{"opacity":0,"x":"0px","y":"-20px"},"triggers":[{"type":"load","stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"from-top-on-load-2","name":"From Top on Load 2","value":{"style":{"opacity":0,"x":"0px","y":"-20px"},"triggers":[{"type":"load","stepsA":[{"wait":500},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"from-top-on-load-3","name":"From Top on Load 3","value":{"style":{"opacity":0,"x":"0px","y":"-20px"},"triggers":[{"type":"load","stepsA":[{"wait":900},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"fade-on-scroll","name":"Fade on Scroll","value":{"style":{},"triggers":[{"type":"scroll","offsetTop":"50%","offsetBot":"50%","stepsA":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"opacity":0.2,"transition":"opacity 500ms ease 0ms"}]}]}}
]);
